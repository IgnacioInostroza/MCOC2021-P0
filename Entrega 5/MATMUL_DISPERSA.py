...
N = [2, 5, 10, 15, 20, 30, 45, 50, 60, 75, 125, 160, 200, 250, 350, 500, 600, 800, 1000, 2000, 5000, 8000, 10000, 12000, 14000, 16000, 20000]


names = ["MATMUL_dispersa.txt"]
...
data = np.loadtxt("MATMUL_dispersa.txt")
Ns = data[:,0]
dts1 =  data[:,1]
dts2 = data[:, 2]
Nsmax = max(Ns)
...
plt.tight_layout()
plt.legend()
plt.savefig("Matmul_dispersa.png")
