...
def matriz_laplaciana(N, t=np.longdouble):    # funcion obtenida de clase
...
for corrida in range(corridas):
    ...
    name = (f"longdouble3{corrida}.txt")
...
for n in range(10):
    ...
    time = []
    memory = []
    with open(f"longdouble3{n}.txt", "r") as f:
...
plt.title("Rendimiento caso3_longdouble")
...
plt.grid(True)
plt.savefig("Rendimiento caso3_longdouble.png")