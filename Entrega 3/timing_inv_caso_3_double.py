...
def matriz_laplaciana(N, t=np.double):    # funcion obtenida de clase
    e=np.eye(N)-np.eye(N,N,1)
    return t(e+e.T)


Ns = [2, 5, 10,12, 15, 20, 30, 40, 45, 50, 55, 60, 75, 100, 125, 160, 200, 250, 350, 500, 600, 800, 1000, 2000, 3000]
...
for n in range(10):
    ...
    time = []
    memory = []
    with open(f"double3{n}.txt", "r") as f:
...
plt.title("Rendimiento caso3_double")
...
plt.grid(True)
plt.savefig("Rendimiento caso3_double.png")